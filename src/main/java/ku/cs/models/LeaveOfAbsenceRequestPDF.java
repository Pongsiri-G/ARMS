...
public class LeaveOfAbsenceRequestPDF {
    ...
    public static void createRequest(String requestsDirectory, LeaveOfAbsenceRequest request) throws IOException {
        ...
        Paragraph textDateRight = new Paragraph(
                "วันที่ " + request.getLastModifiedDateTime() + "\n" +
                        "Date               DD/MM/YY")
                .setPaddingTop(-20)
                .setFixedLeading(14)
        ...
        Paragraph nisitInfo1 = new Paragraph()
                ...
                .add(new Tab())
                .addTabStops(new TabStop(225, TabAlignment.LEFT))
                .add(new Paragraph("Academic Level").setFont(thaiFont).setFontSize(10).setTextAlignment(TextAlignment.LEFT))
                .add(new Tab())
                .addTabStops(new TabStop(350, TabAlignment.LEFT))
        ...
        Paragraph nisitInfo3 = new Paragraph()
                .setFixedLeading(4)
                .add(new Paragraph("มีความประสงค์ขอลงพักการศึกษาเป็นจำนวน: " + request.getToSemester() + " ภาคการศึกษา       ตั้งแต่ภาค: " + request.getFromSemester() + " ปีการศึกษา: " + request.getFromAcademicYear() + "    ถึงภาค: " + request.getToSemester() + " ปีการศึกษา: " + request.getToAcademicYear()).setFont(thaiFont).setFontSize(14).setTextAlignment(TextAlignment.LEFT))
                .add("\n")
        ...
        Paragraph nisitInfo4 = new Paragraph()
                .setFixedLeading(4)
                .add(new Paragraph("อนึ่ง ข้าพเจ้าได้ลงทะเบียนเรียนไว้ในภาค. . . . ปีการศึกษา. . . .ดังนี้").setFont(thaiFont).setFontSize(14).setTextAlignment(TextAlignment.LEFT))
                .add("\n")
