...
//
//        Advisor advisor1 = new Advisor("advisor1", "password1", "Advisor One", science, computerScience, "A101", true, false);
//        Advisor advisor2 = new Advisor("advisor2", "password2", "Advisor Two", science, math, "A102", true, false);
//
//        // Creating test students
//        students.add(new Student("student1", "password1", "John Doe", science, computerScience, "S001", "johndoe@ku.th", false, false));
//        students.add(new Student("student2", "password2", "Jane Doe", science, math, "S002", "janedoe@ku.th", false, false));
//        students.add(new Student("student3", "password3", "Jim Beam", engineering, civilEngineering, "S003", "jimbeam@ku.th", false, false));
//        students.add(new Student("student4", "password4", "Jack Daniels", engineering, computerEngineering, "S004", "jackdaniels@ku.th", false, false));
//
