...
public class UserListFileDatasourceTest {
    ...
    public void loadAdvisorList(){
        ...
        advisorList.add(new Advisor("Pang", "Ux5G63Y", "ปาณิตา พันธ์ภูผา", "วิศวกรรมศาตร์", "วิศวกรรมคอมพิวเตอร์", "A12347", "advisor3@example.com", false, false));
        advisorList.add(new Advisor("Tai", "cN76A0S", "วันชัย เกียรติบวรสกุล", "วิศวกรรมศาตร์", "วิศวกรรมคอมพิวเตอร์", "A12348", "advisor4@example.com", false, false));
    ...
    public void loadStudent(){
        ...
        studentList.add(new Student("กรีฑา พิพัฒนกุล","วิศวกรรมศาตร์", "วิศวกรรมคอมพิวเตอร์", "b6625500002", "studentmail3@ku.th", new Advisor("ปาณิตา พันธ์ภูผา")));
        studentList.add(new Student("ณัฐวดี ทรัพย์ธารา","วิศวกรรมศาตร์", "วิศวกรรมคอมพิวเตอร์", "b6625500003", "studentmail4@ku.th", new Advisor("ปาณิตา พันธ์ภูผา")));
