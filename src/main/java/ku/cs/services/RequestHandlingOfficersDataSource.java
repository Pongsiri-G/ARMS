...
public class RequestHandlingOfficersDataSource implements Datasource<ArrayList<RequestHandlingOfficer>> {
    ...
    public ArrayList<RequestHandlingOfficer> readData() {
        ArrayList<RequestHandlingOfficer> officers = new ArrayList<>();
        String filePath = directoryName + File.separator + fileName;
        ...
        try {
            ...
            while ((line = buffer.readLine()) != null) {
                ...
                officers.add(new RequestHandlingOfficer(name, position));
            }
        } catch (IOException e) {
            throw new RuntimeException(e);
        }
    ...
    public void writeData(ArrayList<RequestHandlingOfficer> data) {
        ...
        try {
            ...
            for (RequestHandlingOfficer officer : data) {
                String line = officer.getName() + "," + officer.getPosition();
                buffer.append(line);
                buffer.append("\n");
            }
        } catch (IOException e) {
